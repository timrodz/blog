...
export function GET(request: Request) {
  ...
  const title = url.searchParams.get("title") || "Juan Rodríguez Morais";

  return new ImageResponse(
    (
      <div tw="flex flex-col w-full h-full items-center justify-center bg-teal-100">
        <div tw="flex flex-col w-full py-12 px-6 md:items-center justify-center p-8 text-4xl text-teal-800">
