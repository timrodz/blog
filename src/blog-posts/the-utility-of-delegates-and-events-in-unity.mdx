---
title: The Utility of Delegates and Events in Unity
publishedAt: '2019-09-25'
summary: "Learn how Unity handles events with the delegate system and UnityEvents as well'
---

This is a basic guide. If you want a more advanced one, [@damagefilter](https://twitter.com/damagefilter/) wrote a more advanced tutorial regarding events in Unity. Go check it out [here](http://www.indiedb.com/members/damagefilter/blogs/event-and-unity) 😄
